...
_datasets = [
    ...
    # ('/Users/av/Datasets/graph-communities/all.csv', 0, 52310, 'CommunitiesFB'),

    # Average degree 90.
    # http://networkrepository.com/rec-eachmovie.php
    # ('/Users/av/Datasets/graph-eachmovie-ratings/all.csv', 0, 2811716, 'MovieRatings'),

    # Patent Citation Network. 77 Mb.
    # Average degree: 8.
    # http://networkrepository.com/cit-patent.php
    ('/Users/av/Datasets/graph-patent-citations/all.csv',
     0, 16518947, 'PatentCitations'),
    ...
    ('/Users/av/Datasets/graph-mouse-gene/all.csv', 0, 14506199, 'MouseGenes'),

    # HumanBrain Network. 4 Gb in CSV.
    # Average degree: 186.
    # 87'273'967 edges.
    # http://networkrepository.com/bn-human-Jung2015-M87102575.php
    ('/Users/av/Datasets/graph-human-brain/all.csv', 0, 87273967, 'HumanBrain'),
